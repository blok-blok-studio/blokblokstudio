  ...
  oneTime: [
    {
      ...
      scope: [
        ...
        { i: 'Content & copy', l: 'Client provides all written content (headlines, body copy, bios, service descriptions). We handle layout, formatting, and placement. If you need copywriting, it can be added.' },
      ],
      ov: ['Extra revision round:', 'Copywriting:', 'Additional section:'],
      ho: 'Payment: 50% deposit to start, 50% due upon completion (Net 7). Complete upon client sign-off OR after 2 revision rounds. Post-sign-off.',
      bridge: 'Includes 14 days of post-launch monitoring (bug fixes and minor tweaks). Need more pages or features? Upgrade to our Starter Launch for a full 5-page site with AI chat and CRM setup.',
    ...
    },
    {
      ...
      ov: ['Additional pages:', 'Extra revision round:', 'Copywriting:', 'Additional Q&A (25+):', 'Additional automation each'],
      ho: 'Payment: 50% deposit to start, 50% due upon completion (Net 7). Complete upon client sign-off OR after 2 revision rounds. Post-sign-off.',
      bridge: 'Includes 30 days of post-launch monitoring (bug fixes, chatbot checks, CRM health). After day 30, ongoing maintenance, updates, and AI tuning transition to our Maintain & Monitor plan so your systems stay optimized.',
    ...
    },
    {
      ...
      ov: ['Additional pages:', 'Extra revision:', 'Additional ad campaign,500', 'Additional voice script:', 'Automations (8+) each', 'Extra landing page:', 'Copywriting beyond included:'],
      ho: 'Payment: 50% deposit to start, 50% due upon completion (Net 7). Complete upon sign-off OR 3 revision rounds. Post-sign-off.',
      bridge: 'Includes 30 days post-launch: ad management, AI monitoring, and bug fixes. After day 30, your ads, AI agents, and automations need ongoing optimization to keep performing. We recommend our Growth Engine plan to maintain momentum.',
    ...
    },
    {
      ...
      ov: ['Additional pages:', 'Extra revision:', 'Additional AI agent,500', 'Additional ad campaign,500', 'Voice script:', 'Automations (15+) each', 'Products (20+):', 'Content after month 1: requires retainer'],
      ho: 'Payment: 50% deposit to start, 25% at midpoint milestone, 25% due upon completion (Net 7). Complete upon sign-off OR 3 rounds. Post-sign-off.',
      bridge: 'Includes 45 days post-launch: full monitoring, ad management, AI tuning, and bug fixes. After day 45, your AI ecosystem, ad campaigns, and content systems need ongoing management to deliver results. We recommend our Full Partnership or Growth Engine based on your needs.',
  ...
  socialSetup: [
    {
      ...
      ov: ['Additional platform each', 'Extra post templates each', 'Extra launch posts (4+) each', 'Revision round:', 'Video content (Reels/Shorts) each'],
      ho: 'Payment: 50% deposit to start, 50% due upon completion (Net 7). Complete upon sign-off OR 1 revision round. Post-delivery changes.',
      bridge: 'Your profiles are set up and ready to go. To keep them active and growing, add our Social Starter plan or individual platform management starting.',
    ...
    },
    {
      ...
      ov: ['Additional platform each', 'Extra templates each', 'Extra launch posts (6+) each', 'Revision round:', 'Video content each', 'Additional link-in-bio page:'],
      ho: 'Payment: 50% deposit to start, 50% due upon completion (Net 7). Complete upon sign-off OR 2 revision rounds. Post-delivery.',
      bridge: 'All platforms launch-ready with 30 days of content planned. To keep growing, we recommend our Social Growth plan or per-platform add-ons.',
    ...
    },
    {
      ...
      ov: ['Additional platform each', 'Extra templates each', 'Extra launch posts (8+) each', 'Extra video each', 'Revision round:', 'YouTube intro/outro video:'],
      ho: 'Payment: 50% deposit to start, 50% due upon completion (Net 7). Complete upon sign-off OR 2 revision rounds. Post-delivery.',
      bridge: 'Your entire social presence is rebuilt and launch-ready with 60 days of content. To maintain momentum, we recommend Social Domination or Social Growth.',
  ...
  monthly: [
    {
      ...
      scope: [
        ...
        { i: 'Support', l: 'Text and email support only (no phone, no live calls at this tier). 48-hour response time during business days (M\u2013F 9\u20135). Up to 10 support requests per month. Each request = 1 specific ask (not a list of changes). Requests beyond 10 billed.' },
      ],
      ov: ['Design beyond 2hr:', 'New page:', 'Live call:', 'Automations (3+) each', 'Emergency/same-day: +50%'],
    ...
    },
    {
      ...
      ov: ['Design beyond 5hr:', 'Ad spend >: per tier', 'Blog each', 'Social posts (12+) each', 'Creative refresh:', 'Additional live call:', 'New AI agent,500', 'Emergency: +50%'],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Ad management (expanded)', l: 'Unlimited active campaigns across Google and Meta. Full-funnel strategy: awareness, consideration, and conversion campaigns. Monthly creative refreshes, audience testing, bid optimization, and budget reallocation. Ad spend up to managed. Ad spend above requires custom pricing. Monthly ad performance report with ROAS, CPA, and budget efficiency analysis. Ad spend billed separately.' },
        ...
        { i: 'Quarterly brand refresh', l: '1 brand refresh per quarter (every 3 months). Includes 5 new creative assets: updated social templates, seasonal ad creatives, refreshed email headers, or new promotional graphics. Does NOT include a full rebrand (new logo, new guidelines, new brand system). Full rebrands quoted separately.' },
      ],
      ov: ['Design beyond 15hr:', 'Ad spend >: custom', 'Blogs each', 'Video clips (4+) each', 'Shooting: separate', 'Full rebrand separate', 'AI agent each', 'Weekend/after-hours: +75%'],
      ex: 'No in-person events, no PR/media outreach, no video shooting (edit only), no app development. Quoted separately.',
      ideal: 'Businesses investing in ads',
    },
  ],
  social: [
    {
      ...
      ov: ['Additional platform:', 'Extra posts (8+) each', 'Video reel/short each', 'Additional revision round:', 'Story creation:'],
    ...
    },
    {
      ...
      ov: ['Additional platform:', 'Extra posts (12+) each', 'Extra video each', 'Video shooting: quoted separately', 'Additional live call:', 'Influencer outreach add-on', 'Story creation:'],
    ...
    },
    {
      ...
      ov: ['Extra platform:', 'Extra posts (20+) each', 'Extra long-form video each', 'Video shooting: quoted separately', 'Influencer beyond 5:', 'Paid ad management: add from main packages', 'Additional live call:', 'Weekend content: +50%'],
  ...
  customBuild: [
    {
      ...
      ov: ['Additional wireframe screens each', 'Extra user flow diagrams each', 'Competitive analysis add-on (audit 3 competitor products)', 'Discovery extension beyond 2 weeks,200/week'],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Revisions', l: '2 rounds of design revisions before development. During development, feedback is handled via a shared task board (Linear or GitHub Issues). Post-development: 1 round of revisions on the final product before launch. Scope changes during development require a change order with pre-approved rates.' },
      ],
      ov: ['Additional integrations each', 'Extra screens beyond SOW:', 'Change orders during development:', 'Additional user roles per role', 'Advanced reporting/analytics dashboard,000', 'Native mobile app (iOS or Android): see Enterprise Build tier'],
      ...
      bridge: 'Your platform is live and stable. To keep it running, secure, and evolving, we recommend our Dev Support retainer or an Hourly Bank.',
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Revisions & change management', l: '2 rounds of design revisions per phase. Feedback managed via shared task board (Linear or GitHub Issues). Change orders for scope additions with written approval before work begins. Weekly status updates via Loom video or written summary. Bi-weekly recorded demo videos of completed work \u2014 you review and respond on your own time. 1 optional live call per month if needed.' },
      ],
      ov: ['Additional integrations each', 'Native mobile app (if not included),000', 'AI feature additions per feature', 'Additional phases: scoped and quoted individually', 'Third-party pen test coordination,000', 'White-label/multi-tenant add-on (if not included),000'],
      ...
      bridge: 'Complex systems require ongoing development, monitoring, and optimization. We recommend our Active Development retainer to keep your platform evolving with your business.',
  ...
  aiAgents: [
    {
      ...
      ov: ['Additional integration,500', 'Training data beyond 50 items of 50', 'Extra revision round:', 'Rush delivery (under 1 week): +40%', 'Agent retraining:'],
      ...
      bridge: 'Your agent is live \u2014 to keep it monitored, optimized, and retrained, add our Agent Maintenance or Agent Growth retainer.',
    ...
    },
    {
      ...
      ov: ['Additional agent,500', 'Additional integration,500', 'Training data beyond 75/agent:', 'Extra revision round:', 'Rush delivery: +40%'],
      ...
      bridge: 'Your agent team is live and coordinated. For ongoing optimization, retraining, and new agent additions, add our Agent Growth or Agent Command Center retainer.',
    ...
    },
    {
      ...
      ov: ['Additional agent each', 'Additional integration,000', 'Custom AI model fine-tuning,000', 'Live training call:', 'Rush delivery: +30%'],
      ...
      bridge: 'Your AI ecosystem is fully operational. To keep it running, optimized, and expanding, add our Agent Command Center retainer.',
  ...
  monthlyAgent: [
    {
      ...
      scope: [
        ...
        { i: 'Support', l: 'Text and email support with 48-hour response time (business days). Up to 8 support requests per month. Each request = 1 specific issue or question. Requests beyond 8 billed.' },
      ],
      ov: ['Additional agent monitoring per agent', 'Training updates beyond 15 each', 'Emergency off-hours fix: +50%', 'New agent build: quoted separately'],
    ...
    },
    {
      ...
      ov: ['Additional agent monitoring per agent', 'Training updates beyond 40 each', 'Additional workflow build,500', 'New agent build,500', 'Emergency off-hours: +50%'],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'New agent builds (1/mo included)', l: '1 new AI agent build per month included in scope. Covers: design, training, testing, deployment, and documentation. Additional agents quoted at discounted rate.' },
      ...
      ov: ['Additional agent build each', 'Additional workflow,000', 'Custom AI model fine-tuning,000', 'Live training call:', 'Emergency off-hours: +50%'],
  ...
  customSupport: [
    {
      ...
      scope: [
        { i: 'Choose your hours', l: 'Purchase a block of development hours each month. 10 hrs/mo =. 20 hrs/mo =. 30 hrs/mo =. 40+ hrs/mo = custom rate. Hours cover any combination of: bug fixes, feature updates, design changes, integrations, or consulting.' },
      ...
      ov: ['Hours beyond your bank:', 'Emergency/same-day critical fix: +50% on hours used', 'Weekend work: +75% on hours used'],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Support channel', l: 'Email support with 24-hour response time (business days). Up to 8 support requests per month. Each request = 1 specific issue or question. Requests beyond 8 billed.' },
      ],
      ov: ['Bug fixes beyond 5hr:', 'Emergency off-hours response: +50%', 'Database migration: quoted separately', 'Feature additions: use Hourly Bank or project pricing', 'Performance audit one-time'],
    ...
    },
    {
      ...
      ov: ['Development beyond 35hrs:', 'Emergency off-hours: +50%', 'Weekend deployment: +75%', 'Full feature build exceeding 40hrs: scoped as separate project at discounted rate', 'Design beyond 3hrs:'],
  ...
  appBuild: [
    {
      ...
      ov: ['Extra screen:', 'Second platform (add iOS or Android): ', 'Extra API integration:', 'Tablet/iPad layouts: '],
      ...
      bridge: 'After the 30-day warranty, ongoing maintenance transitions to our Keep Alive plan to stay current with iOS/Android updates and store resubmissions.',
    ...
    },
    {
      ...
      ov: ['Extra screen:', 'Custom native module:', 'Additional integration:', 'Extended warranty (+30 days),200'],
      ...
      bridge: 'Includes 60 days post-launch. Active iteration after that runs on our Momentum plan \u2014 20 engineering hours, feature work, and A/B tests monthly.',
    ...
    },
    {
      ...
      ov: ['Extra screen,100', 'Custom native module:', 'Additional real-time feature,500', 'Extra discovery workshop,800'],
      ...
      bridge: 'Includes 90 days post-launch. Embedded partnership after that runs on our Partner plan with a dedicated engineer and fractional designer.',
  ...
  appSupport: [
    {
      ...
      ov: ['Extra hour:', 'Emergency hotfix (weekend/holiday) flat + hours', 'Dedicated feature work: scoped separately'],
    ...
    },
    {
      ...
      ov: ['Extra hour:', 'Additional A/B test setup', 'Rush feature (under 1 week turnaround): 1.5x hours', 'Additional design hour:'],
    ...
    },
    {
      ...
      ov: ['Extra hour beyond 95/mo:', 'Additional dedicated engineer: ', 'Additional dedicated designer: '],
  ...
  webSupport: [
    {
      ...
      ov: ['Extra content edit each', 'Rush request (same day): ', 'Hour-long update work:'],
    ...
    },
    {
      ...
      ov: ['Extra A/B test:', 'Additional new page:', 'Video/animation work: scoped separately'],
    ...
    },
    {
      ...
      ov: ['Extra hour beyond 33/mo:', 'Additional content page load each beyond 10', 'Rush deploy (same day): +25%'],
  ...
  marketingBuild: [
    {
      ...
      ov: ['Additional channel audited:', 'Additional competitor in teardown each', 'Extended workshop session (90 min):'],
      ex: 'No execution of the roadmap (that\u2019s the next step). No ad management. No content creation. No creative production.',
      bridge: 'Audit pairs naturally with our Maintain & Monitor plan to execute the roadmap without rebuilding context. 10% first-month discount if signed within 14 days.',
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Up tok managed ad spend', l: 'Ad spend up tok covered inside the fee (spend itself is billed separately by the platform). Additionalk of spend: to the fee.' },
      ...
      ov: ['Additional ad creative (static):', 'Additional ad creative (video):', 'Additional landing page variant,500', 'Additional ad platform,500'],
      ex: 'No organic social content. No long-form SEO content. No influencer management. No PR outreach.',
      bridge: 'Campaign transitions into our Growth Engine plan to scale winners, expand to a 2nd channel, and iterate creative. 10% first-month discount if signed within 14 days.',
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Up tok managed launch spend', l: 'Up tok of ad spend managed inside the fee. Additionalk of spend: to the fee. Spend billed separately by the platform.' },
      ],
      ov: ['Additional influencer partnership + creator fees', 'Extra press outlet (26+) each', 'Additional video creative:', 'Rush timeline (under 3 weeks): +25%', 'Programmatic SEO module,000'],
      ex: 'No ongoing content calendar past launch. No long-term community management. No product photography (can be added).',
      bridge: 'Launch converts into our Full Partnership plan for sustained growth, lifecycle optimization, and the next launch cycle. 10% first-month discount if signed within 14 days.',
  ...
  brandingBuild: [
    {
      ...
      ov: ['Additional logo variation (monogram, submark, etc.):', 'Extra revision round:', 'Brand photography direction:'],
      ex: 'No brand guidelines document. No stationery. No social templates. No naming or verbal identity work.',
      bridge: 'Brand Lite paired with Brand Keeper keeps assets consistent as you produce new content.',
    ...
    },
    {
      ...
      ov: ['Custom icon set (8 icons),200', 'Brand photography art direction + shot list:', 'Extra revision round:'],
      ex: 'No naming or verbal identity sprint. No trademark research. No brand book beyond the 20-page guidelines. No video work.',
      bridge: 'Brand System pairs with Creative Direction to keep producing new branded assets consistently.',
    ...
    },
    {
      ...
      ov: ['Trademark legal opinion via partner attorney,500- passthrough', 'Brand launch video production (60s),500', 'Additional naming round,000'],
      ...
      bridge: 'Transformation is typically followed by Embedded Studio to roll out the new identity across every surface over the next 6 months.',
  ...
  brandingSupport: [
    {
      ...
      ov: ['Extra assets (7+) each', 'Rush 48-hr turnaround: +50%', 'Short-form video edit each'],
    ...
    },
    {
      ...
      ov: ['Extra assets (16+) each', 'Short-form video edit (under 60s) each', 'Copy beyond 1,000 words:'],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Brand system evolution', l: 'Minor system updates as you scale \u2014 new templates, adjusted color extensions, new sub-brand marks. Full rebrands still quoted separatelyk+.' },
      ...
      ov: ['Full rebrand:k+ separate', 'Brand photography day (direction + vendor management, shoot billed passthrough) direction fee', 'Additional embedded designer: '],
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, color: MU, maxWidth: 520, margin: '0 auto 24px', lineHeight: 1.6, fontWeight: 300 }}>
            AI-powered websites, automations, ads, and social media management. Defined deliverables, no surprises.
          </p>
          ...
          {pkgData[section.dataKey].map((pk, i) => {
            ...
            return (
              <div key={cardId} style={{
                ...
                <h2 style={{ fontFamily: "'Syne'", fontWeight: 800, fontSize: 22, margin: '0 0 10px' }}>{pk.name}</h2>
                ...
                {(pk.ex || pk.bridge) && (
                  <>
                    <button onClick={() => setExp(isE ? null : cardId)} style={{ marginTop: 14, width: '100%', padding: '8px', borderRadius: 8, cursor: 'pointer', fontSize: 11, fontWeight: 600, fontFamily: 'inherit', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)', color: MU, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                      <Chev open={isE} /> {isE ? 'Hide' : 'View'} Details
                    </button>
                    {isE && (
        ...
        {tab === 'aiAgents' && (
          <div style={{ background: 'rgba(255,255,255,0.015)', border: `1px solid ${BO}`, borderRadius: 14, padding: '22px 18px', marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 11, color: FA, marginBottom: 16 }}>Each agent is custom-built for your business and includes deployment, testing, and documentation. Ongoing monitoring and optimization available via our monthly Agent retainers.</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              {([
                ...
                <div key={idx} style={{ padding: '12px 14px', borderRadius: 8, background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.025)' }}>
                  <div style={{ fontSize: 13, fontWeight: 600, color: '#bbb', marginBottom: 4 }}>{n}</div>
              ...
              <div style={{ padding: '12px 14px', borderRadius: 8, background: 'rgba(249,115,22,0.03)', border: '1px solid rgba(249,115,22,0.15)' }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#bbb', marginBottom: 4 }}>API Integration</div>
