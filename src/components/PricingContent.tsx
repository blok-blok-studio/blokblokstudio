  ...
  monthly: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Async strategy updates', l: 'Monthly recorded Loom video walkthrough covering your performance, recommendations, and next steps (10\u201315 min). You respond async via text, email, or voice memo \u2014 no live calls required. Questions answered within 1 business day via text or email. 1 optional live call per month available on request (30 min max).' },
    ...
    },
    {
      ...
      com: '6-month minimum',
      scope: [
        { i: 'Everything in Growth Engine', l: 'All website maintenance, AI monitoring, reports, CRM management, Google + Meta ads management, AI content production, AI optimization, async strategy updates, and email support \u2014 with expanded limits listed below. Design hours and async updates replaced by expanded versions below (not stacked).' },
        { i: 'Dedicated strategist', l: 'Named point of contact who knows your business, goals, and brand. Available via text or email Monday\u2013Friday 9AM\u20135PM (your time zone). Not available 24/7, weekends, or holidays. Manages all deliverables, coordinates the team, and proactively brings recommendations via async updates (Loom, email, or text). Responds within 4 business hours during working days.' },
        ...
        { i: 'Monthly strategy meeting + async updates', l: '1 live strategy meeting per month (60 min max). Weekly async updates delivered via Loom video or written summary covering: performance review, upcoming priorities, campaign adjustments, and strategic recommendations. You respond via text, email, or voice memo. Day-to-day communication is fully async \u2014 no ad-hoc calls.' },
  ...
  social: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Reporting & async strategy', l: 'Bi-monthly report (delivered on the 1st and 15th) covering: follower growth, reach, engagement rate, top posts, and audience demographics. 1 monthly Loom video walkthrough with performance review, content recommendations, and trend opportunities. You respond async via text or email. 1 optional live call per month available on request (30 min max).' },
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Reporting & async strategy', l: 'Weekly analytics snapshot emailed every Monday (key metrics across all platforms). Monthly deep-dive report (delivered by the 5th): follower growth, engagement rates, reach, impressions, top content, audience demographics, and competitor benchmarking. Monthly Loom video walkthrough covering: performance review, upcoming campaigns, content direction, and growth opportunities. You respond async via text or email. 1 optional live call per month on request (30 min max).' },
  ...
  customBuild: [
    {
      ...
      tl: '1\u20132 weeks',
      scope: [
        { i: 'Kickoff questionnaire + async workshop', l: 'Detailed intake questionnaire covering: business goals, user types and roles, core features, must-haves vs. nice-to-haves, integrations (payment, CRM, email, APIs), and timeline expectations. We review your responses and deliver a recorded Loom walkthrough of our understanding and follow-up questions. You respond async via text, email, or voice memo. 1 optional live call available if needed (60 min max).' },
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Revisions & change management', l: '2 rounds of design revisions per phase. Feedback managed via shared task board (Linear or GitHub Issues). Change orders for scope additions: $200/hr with written approval before work begins. Weekly async status updates via Loom video or written summary. Bi-weekly recorded demo videos of completed work \u2014 you review and respond async. 1 optional live call per month if needed.' },
      ],
  ...
  aiAgents: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Training & onboarding', l: 'Each agent trained on up to 150 data points. Comprehensive recorded Loom walkthrough series showing your team how to manage, monitor, and update agents. Runbook documentation for every agent: what it does, how to modify it, and troubleshooting steps. All training delivered async \u2014 your team watches on their own time. Questions answered via text or email within 1 business day.' },
        { i: '90-day support & optimization', l: '90 days of active monitoring, optimization, and iteration. Weekly async performance updates with recommendations delivered via Loom or email. Up to 50 training updates per agent. Monthly optimization report with ROI analysis. After 90 days, transitions to ongoing AI Operations retainer.' },
      ],
  ...
  customSupport: [
    {
      ...
      scope: [
        ...
        { i: 'What\u2019s covered', l: 'Bug fixes and patches, minor feature additions, UI/UX improvements, database changes, API updates, third-party integration maintenance, performance optimization, security patches, and async consulting. Does NOT include: full feature builds requiring 40+ hours (scoped as a separate project), design-from-scratch work (use our design retainer or project pricing), or 24/7 on-call support.' },
      ],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Priority support', l: 'Text and email support with 4-hour response time (business days). Critical bugs: same-day start during business hours. Up to 15 support requests per month. All communication async \u2014 no scheduled calls required.' },
              ...
              {[
                ...
                },
                {
                  ...
                  items: [
                    ...
                    '1 monthly Loom strategy update (respond async)',
