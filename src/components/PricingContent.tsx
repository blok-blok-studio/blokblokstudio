...
const pkgData: Record<string, Package[]> = {
  oneTime: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Content & copy', l: 'We write copy for your homepage and services page (1,500 words total). All other page content provided by you. Blog CMS delivered empty so you or your team can create posts, or add our content package.' },
      ],
  ...
  socialSetup: [
    {
      ...
      scope: [
        ...
        { i: 'Profile optimization', l: 'Bio written and tailored to each platform (up to 150 characters for IG, up to 2,000 for LinkedIn, etc.). Profile photo resized and optimized for the platform. Cover image or banner custom-designed to match your brand. Featured sections, highlights, or pinned posts configured (where applicable). Contact info, website link, CTA buttons, and category/industry tags set up.' },
        ...
        { i: 'Hashtag & keyword strategy', l: 'Platform-specific hashtag or keyword research based on your industry and target audience. 3 hashtag/keyword sets delivered (e.g., 1 broad reach set, 1 niche set, 1 branded set). Each set contains 15 to 30 hashtags or keywords. Delivered as a shareable document with usage instructions.' },
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Hashtag & keyword strategy', l: 'Per-platform research based on your industry and competitors. 5 hashtag or keyword sets per platform (15 total). Each set contains 15 to 30 hashtags/keywords organized by: broad reach, niche, branded, trending, and location-based. Delivered as a shared spreadsheet or doc with usage guidelines.' },
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Social media audit', l: 'Detailed review of each existing profile: follower demographics, engagement rates, top-performing content, posting consistency, and profile completeness score. Competitor benchmarking against 3 competitors you choose (or we recommend). Gap analysis identifying missed opportunities in content, hashtags, engagement, and platform features. Delivered as a written audit report (PDF, 3 to 5 pages) with actionable recommendations.' },
  ...
  monthly: [
    {
      ...
      scope: [
        ...
        { i: 'Support', l: 'Text and email support only (no phone, no live calls at this tier). 48-hour response time during business days (Monday to Friday, 9 to 5). Up to 10 support requests per month. Each request = 1 specific ask (not a list of changes). Requests beyond 10 billed at $175/hr.' },
      ],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Strategy updates', l: 'Monthly recorded Loom video walkthrough covering your performance, recommendations, and next steps (10 to 15 min). You respond via text, email, or voice memo. No live calls required. Questions answered within 1 business day via text or email. 1 optional live call per month available on request (30 min max).' },
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Dedicated strategist', l: 'Named point of contact who knows your business, goals, and brand. Available via text or email Monday to Friday, 9AM to 5PM (your time zone). Not available 24/7, weekends, or holidays. Manages all deliverables, coordinates the team, and proactively brings recommendations via Loom, email, or text. Responds within 4 business hours during working days.' },
  ...
  social: [
    {
      ...
      scope: [
        ...
        { i: 'Basic engagement', l: 'Up to 30 minutes per day (business days only, Monday to Friday). Includes: responding to comments and direct messages, liking relevant comments, and flagging any issues or negative feedback for your review. Does NOT include proactive outreach or community building.' },
        ...
        { i: 'Hashtag strategy', l: 'Initial hashtag research for both platforms at onboarding (3 sets of 15 to 30 hashtags each). Updated once per quarter. Sets organized by: broad reach, niche, and branded/local hashtags.' },
      ],
      ...
      ideal: 'Businesses needing consistent presence on 1 to 2 channels',
    },
    {
      name: 'Social Growth',
      price: 2500,
      ...
      scope: [
        ...
        { i: 'Active engagement', l: 'Up to 1 hour per day (business days, Monday to Friday). Includes: responding to all comments and DMs, liking and replying to mentions, and proactive engagement on relevant accounts in your industry (30 min/day for liking, commenting, following). Brand monitoring for mentions and tags. Negative comments or PR issues flagged to you immediately.' },
        ...
        { i: 'Monthly content strategy', l: 'Monthly content pillars defined (3 to 5 themes that guide all content). Trend monitoring and recommendations for timely/reactive posts. Hashtag strategy maintained and updated monthly across all platforms.' },
      ],
  ...
  customBuild: [
    ...
    },
    {
      ...
      tl: '6 to 12 weeks',
      scope: [
        { i: 'Full UI/UX design', l: 'Complete interface design in Figma for all screens (typically 15 to 30 screens depending on complexity). Includes: responsive layouts for desktop and mobile, component library, design system with your brand colors/fonts/spacing, and interactive prototype for stakeholder review. 2 rounds of design revisions before development begins.' },
    ...
    },
    {
      ...
      tl: '12 to 24 weeks',
      scope: [
        { i: 'Everything in Standard Build (expanded)', l: 'All design, frontend, backend, integrations, hosting, testing, and documentation from the Standard Build, with expanded scope for larger, more complex systems. Typically 30 to 60+ screens, multiple user roles, and complex business logic.' },
        ...
        { i: 'Phased delivery', l: 'Project delivered in phases (typically 3 or 4 phases). Each phase has its own deliverables, testing, and sign-off. Phase 1 is usually core MVP (launched to production). Subsequent phases add features incrementally. Each phase has a defined timeline and deliverable list from the SOW.' },
  ...
  aiAgents: [
    ...
    },
    {
      ...
      ho: 'Payment: 50% deposit to start, 25% at midpoint milestone, 25% due upon completion (Net 7). Delivered in phases (typically 2 or 3 phases). Each phase has defined deliverables and sign-off. All code and agent ownership transfers to you at completion.',
  ...
  monthlyAgent: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Training data updates (unlimited)', l: 'Unlimited training data updates across all agents. Script revisions, workflow adjustments, new Q&A pairs, and response tuning, as needed with no caps. Updates delivered within 1 business day.' },
  ...
  marketingBuild: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Email launch sequence', l: 'Waitlist nurture (3 emails pre-launch) + launch-week 6-email campaign. Built for first 50k sends. Works with any platform (Klaviyo, Kit, Mailchimp, or HubSpot).' },
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ fontFamily: "'Syne'", fontWeight: 800, fontSize: 'clamp(26px, 4.5vw, 46px)', lineHeight: 1.08, margin: '0 0 12px', letterSpacing: '-1px', background: 'linear-gradient(135deg, #fff, #999)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            What you get,{' '}
            <span style={{ background: `linear-gradient(135deg, ${O}, ${GL})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>spelled out.</span>
          </h1>
        ...
        <div style={{ marginTop: 32, padding: '28px 22px', borderRadius: 16, background: `linear-gradient(135deg, rgba(249,115,22,0.06), rgba(251,191,36,0.04))`, border: `1px solid rgba(249,115,22,0.18)`, textAlign: 'center' }}>
          ...
          <a href="/start?s=web" style={{ display: 'inline-block', padding: '12px 28px', borderRadius: 10, background: `linear-gradient(135deg, ${O}, ${OD})`, color: '#fff', fontSize: 13, fontWeight: 700, textDecoration: 'none', boxShadow: `0 4px 18px ${OG}` }}>
