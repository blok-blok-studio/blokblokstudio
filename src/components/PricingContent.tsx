  ...
  monthly: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Strategy calls', l: '2 calls per month, 30 minutes each. Must be scheduled at least 48 hours in advance. Written agenda required before each call (we provide a template). Notes and action items delivered within 24 hours after each call. No ad-hoc or unscheduled calls \u2014 additional calls billed at $250/hr.' },
      ...
      ov: ['Design beyond 5hr: $175/hr', 'Ad spend >$5K: +$500/mo per $5K tier', 'Blog: $250 each', 'Social posts (12+): $60 each', 'Creative refresh: $500', 'Strategy call: $250/hr', 'New AI agent: $2,500', 'Emergency: +50%'],
    ...
    },
    {
      ...
      com: '6-month minimum',
      scope: [
        { i: 'Everything in Growth Engine', l: 'All website maintenance, AI monitoring, reports, CRM management, Google + Meta ads management, AI content production, AI optimization, strategy calls, and email support \u2014 with expanded limits listed below. Design hours and strategy calls replaced by expanded versions below (not stacked).' },
        { i: 'Dedicated strategist', l: 'Named point of contact who knows your business, goals, and brand. Available via Slack or email Monday\u2013Friday 9AM\u20135PM (your time zone). Not available 24/7, weekends, or holidays. Manages all deliverables, coordinates the team, and proactively brings recommendations. Responds within 4 business hours during working days.' },
        ...
        { i: 'Strategy calls (expanded)', l: 'Weekly calls, 60 minutes each. Scheduled on a recurring day/time. Each call recorded and followed by a written summary with action items delivered within 24 hours. Covers: performance review, upcoming priorities, campaign adjustments, and strategic recommendations.' },
  ...
  social: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Reporting & strategy calls', l: 'Bi-monthly report (delivered on the 1st and 15th) covering: follower growth, reach, engagement rate, top posts, and audience demographics. 1 strategy call per month (30 min, scheduled in advance). Call includes: performance review, content recommendations, and trend opportunities.' },
      ...
      ov: ['Additional platform: $400/mo', 'Extra posts (12+): $50 each', 'Extra video: $175 each', 'Video shooting: quoted separately', 'Additional strategy call: $250', 'Influencer outreach: $600/mo add-on', 'Story creation: $25/story'],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Reporting & strategy calls', l: 'Weekly analytics snapshot emailed every Monday (key metrics across all platforms). Monthly deep-dive report (delivered by the 5th): follower growth, engagement rates, reach, impressions, top content, audience demographics, and competitor benchmarking. 2 strategy calls per month (30 min each, scheduled in advance). Calls cover: performance review, upcoming campaigns, content direction, and growth opportunities.' },
      ...
      ov: ['Extra platform: $400/mo', 'Extra posts (20+): $40 each', 'Extra long-form video: $500 each', 'Video shooting: quoted separately', 'Influencer beyond 5: $125/outreach', 'Paid ad management: add from main packages', 'Additional strategy call: $250', 'Weekend content: +50%'],
  ...
  customBuild: [
    {
      ...
      tl: '1\u20132 weeks',
      scope: [
        { i: 'Kickoff workshop (90 min)', l: 'Live session with your team to map out the full project. We cover: business goals, user types and roles, core features, must-haves vs. nice-to-haves, integrations (payment, CRM, email, APIs), and timeline expectations. Recorded and summarized.' },
      ...
      ho: 'Discovery fee is credited toward the full build if you proceed within 30 days of delivery. If you don\u2019t proceed, all deliverables (wireframes, SOW, architecture doc) are yours to keep and use with any developer.',
    ...
    },
    {
      ...
      ho: 'Includes 30 days post-launch bug fixes (issues with features in the original SOW only). After 30 days, ongoing support transitions to a maintenance retainer. All code is yours \u2014 full ownership of the codebase, design files, and documentation transferred at project completion.',
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Revisions & change management', l: '2 rounds of design revisions per phase. Feedback managed via shared task board (Linear or GitHub Issues). Change orders for scope additions: $200/hr with written approval before work begins. Weekly status updates and bi-weekly demo calls throughout the project.' },
      ],
      ...
      ho: 'Includes 45 days post-launch bug fixes per phase. All code, design files, and documentation transferred to you at completion. Full codebase ownership. After 45 days, ongoing support transitions to a maintenance retainer.',
  ...
  aiAgents: [
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Training & onboarding', l: 'Each agent trained on up to 150 data points. 2-hour training session with your team on how to manage, monitor, and update agents. Runbook documentation for every agent: what it does, how to modify it, and troubleshooting steps. Video walkthrough of the full system.' },
  ...
  customSupport: [
    {
      ...
      scope: [
        ...
        { i: 'What\u2019s covered', l: 'Bug fixes and patches, minor feature additions, UI/UX improvements, database changes, API updates, third-party integration maintenance, performance optimization, security patches, and consulting/strategy calls. Does NOT include: full feature builds requiring 40+ hours (scoped as a separate project), design-from-scratch work (use our design retainer or project pricing), or 24/7 on-call support.' },
      ],
    ...
    },
    {
      ...
      scope: [
        ...
        { i: 'Product roadmap collaboration', l: 'Monthly roadmap review call (60 min) to plan upcoming features and prioritize your backlog. We maintain a shared task board (Linear or GitHub Issues) with prioritized items, status tracking, and time estimates. You set priorities \u2014 we advise on technical feasibility, effort, and sequencing.' },
        ...
        { i: 'Bi-weekly demos', l: 'Every 2 weeks, we demo completed work and in-progress features. You provide feedback in real-time. Demos recorded and shared with stakeholders. Keeps the project moving and prevents misalignment.' },
        { i: 'Priority support', l: 'Email or Slack support with 4-hour response time (business days). Critical bugs: same-day start during business hours. Up to 15 support requests per month.' },
              ...
              {[
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'Bi-monthly analytics report with growth recommendations',
                    '1 strategy call/mo (30 min)',
