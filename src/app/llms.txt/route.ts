...
export async function GET() {
  ...
  const content = [
    ...
    '## Team',
    '',
    '- **Chase Haynes**, Founder. Based in Berlin, Germany, originally from San Diego, California. Served five years in the US Marine Corps, then took a BFA in Design and Technology at Parsons School of Design. Founded the studio in June 2024.',
    ...
    '- Marketing strategist, based in Los Angeles, USA.',
