...
const data = specialties['webdesign-berlin'];

export const metadata: Metadata = {
  title: data.metaTitle,
  description: data.metaDescription,
  alternates: { canonical: '/webdesign-berlin' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: 'https://www.blokblokstudio.com/webdesign-berlin',
  ...
  return (
    <div className="page-transition">
      ...
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: '/' },
          { name: data.h1, url: '/webdesign-berlin' },
        ]}
      />
