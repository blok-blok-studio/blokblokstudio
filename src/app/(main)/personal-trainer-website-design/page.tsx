...
const data = specialties['personal-trainer-website-design'];

export const metadata: Metadata = {
  title: data.metaTitle,
  description: data.metaDescription,
  alternates: { canonical: '/personal-trainer-website-design' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: 'https://www.blokblokstudio.com/personal-trainer-website-design',
  ...
  return (
    <div className="page-transition">
      ...
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: '/' },
          { name: data.h1, url: '/personal-trainer-website-design' },
        ]}
      />
