...
const data = specialties['plumber-website-design'];

export const metadata: Metadata = {
  title: data.metaTitle,
  description: data.metaDescription,
  alternates: { canonical: '/plumber-website-design' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: 'https://www.blokblokstudio.com/plumber-website-design',
  ...
  return (
    <div className="page-transition">
      ...
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: '/' },
          { name: data.h1, url: '/plumber-website-design' },
        ]}
      />
