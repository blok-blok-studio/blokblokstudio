...
export const projectsData: Record<string, ProjectData> = {
  ...
  'bronco-plumbing': {
    ...
    category: 'Web Design',
    year: '2026',
    desc: 'Lead-generating website and online growth system for a Dallas-Fort Worth plumbing company.',
    challenge: 'Colton Staley launched Bronco Plumbing in Dallas-Fort Worth in 2026 as a first-year, owner-operated company. Starting from zero: no website, no online presence, no way for DFW homeowners searching for a plumber to find him. In the trades, whoever shows up first on Google with proof of quality work gets the call.',
    solution: 'We built a conversion-focused website around Colton himself: owner on every call, honest estimates, real Google reviews pulled in live. Every section drives toward a call or an estimate request, with a sticky mobile call bar for homeowners searching mid-emergency. Local SEO for DFW plumbing searches was built in from day one, and the contact pipeline feeds straight into his job workflow.',
    results: 'In his first 5 months, Colton generated over $50,000 in gross revenue between his plumbing work and the online system. The site holds a 5.0-star rating across 52 Google reviews, ranks at an average position of 5.2 on Google for its search terms, and earned 8,000+ search impressions in its first 3 months of tracking.',
    heroImage: '/images/projects/bronco.webp',
    gallery: ['/images/projects/bronco.webp', '/images/projects/bronco-mobile.webp', null],
    nextSlug: 'coach-kofi',
    url: 'https://www.broncoplumbingdfw.com',
    mobileImage: '/images/projects/bronco-mobile.webp',
    embeddable: true,
  },
  'coach-kofi': {
    title: 'Coach Kofi',
